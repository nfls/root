 ...
 */
class Version20171229021058 extends AbstractMigration
{
    public function up(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE user ADD international_phone BIGINT DEFAULT NULL, ADD join_time DATETIME DEFAULT CURRENT_TIMESTAMP NOT NULL, CHANGE phone domestic_phone BIGINT DEFAULT NULL');
