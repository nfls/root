 ...
 */
class Version20180124040717 extends AbstractMigration
{
    public function up(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE refresh_token CHANGE expiry_time expiry_time DATETIME NOT NULL, CHANGE access_token_id accessTokenId VARCHAR(255) DEFAULT NULL');
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE refresh_token CHANGE expiry_time expiry_time DATETIME NOT NULL, CHANGE accesstokenid access_token_id VARCHAR(255) DEFAULT NULL COLLATE utf8_unicode_ci');
