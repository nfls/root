 ...
 */
class Version20180124000858 extends AbstractMigration
{
    public function up(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE access_token ADD scopes JSON NOT NULL, CHANGE expiry_time expiry_time DATETIME NOT NULL');
        $this->addSql('ALTER TABLE auth_code ADD scopes JSON NOT NULL, CHANGE expiry_time expiry_time DATETIME NOT NULL');
